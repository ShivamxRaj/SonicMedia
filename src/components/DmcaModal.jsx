...
import { X, ShieldAlert, Mail, Check, AlertTriangle } from 'lucide-react';
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '20px' }}>
          <div>
            ...
            <p style={{ fontSize: '0.85rem', color: '#94a3b8', marginTop: '4px', margin: 0 }}>
              Copyright Compliance & Takedown Request Guidelines
            </p>
          </div>
          ...
          {sections.map((item) => (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px' }}>
                <span style={{ fontSize: '0.75rem', fontWeight: 800, color: '#f43f5e', opacity: 0.8 }}>{item.id}</span>
